...
from osvcad.edges import ConstraintCoaxial, ConstraintAbsolutePositionning
...
A.add_edge(n2, n1, object=ConstraintAbsolutePositionning(t=(0, 0, 20),
                                                         r=(0, 0, 0)))

A.add_edge(n2, n3, object=ConstraintAbsolutePositionning(t=(50, 25, 0),
                                                         r=(0, 0, 0)))
